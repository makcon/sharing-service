...
public class SharedItemsSheetBuilderTest {
    ...
    private static final long SHEET_ID_3 = 13;
    private static final long CELL_ID_1 = 111;

    private final SharedItemsSheetBuilder builder = new SharedItemsSheetBuilder();
    ...
    public void build_shouldBuildItemsForEachShareeId() {
        ...
        var expectedItem1 = createSharedItem(SHAREE_ID_1, SHEET_ID_1);
        var expectedItem2 = createSharedItem(SHAREE_ID_2, SHEET_ID_1);
        var expectedItem3 = createSharedItem(SHAREE_ID_1, SHEET_ID_3);
        var expectedItem4 = createSharedItem(SHAREE_ID_2, SHEET_ID_3);
